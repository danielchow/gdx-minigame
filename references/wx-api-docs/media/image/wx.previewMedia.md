> Source: https://developers.weixin.qq.com/minigame/dev/api/media/image/wx.previewMedia.html
...
|  | complete function  否 接口调用结束的回调函数（调用成功、失败都会执行）  ## # 支持长按识别的码 | 类型 | 说明 | 最低版本 | |
| --- | --- | --- |
| 小程序码 |  |  |
| 微信个人码 | 不支持小游戏 | 2.18.0 |

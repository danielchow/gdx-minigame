> Source: https://developers.weixin.qq.com/minigame/dev/api/media/image/wx.saveImageToPhotosAlbum.html
...
**[用户授权](../../../guide/base-ability/authorize.html)**：需要 scope.writePhotosAlbum

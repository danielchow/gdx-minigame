> Source: https://developers.weixin.qq.com/minigame/dev/api/media/recorder/RecorderManager.start.html
...
|  | audioSource string auto 否 指定录音的音频输入源，可通过 [wx.getAvailableAudioSources()](../audio/wx.getAvailableAudioSources.html) 获取当前可用的音频源 [2.1.0](../../../guide/runtime/client-lib/compatibility.html)  | 合法值 | 说明 | |
| --- | --- |

> Source: https://developers.weixin.qq.com/minigame/dev/api/media/audio/InnerAudioContext.html
# InnerAudioContext
...
## 属性
### string src
音频资源的地址，用于直接播放。[2.2.3](../../../guide/runtime/client-lib/compatibility.html) 开始支持云文件ID
### number startTime
开始播放的位置（单位：s），默认为 0
### boolean autoplay
是否自动开始播放，默认为 `false`

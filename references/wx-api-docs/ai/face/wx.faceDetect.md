> Source: https://developers.weixin.qq.com/minigame/dev/api/ai/face/wx.faceDetect.html
...
|  | pitch | number | 仰俯角（点头） |
|  | yaw | number | 偏航角（摇头） |
|  | roll | number | 翻滚角（左右倾） |  faceInfo Array.<Object> 多人模式（enableMultiFace）下的人脸信息，每个对象包含上述其它属性 ### # 特别说明

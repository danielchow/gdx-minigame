> Source: https://developers.weixin.qq.com/minigame/dev/api/network/tcp/wx.createTCPSocket.html
...
## 功能描述
创建一个 TCP Socket 实例。使用前请注意阅读[相关说明](../../../guide/base-ability/network.html)。
## 参数
...
## 连接限制
- 允许与局域网内的非本机 IP 通信
 - 允许与配置过的服务器域名通信，详见[相关说明](../../../guide/base-ability/network.html)

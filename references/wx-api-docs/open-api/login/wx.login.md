> Source: https://developers.weixin.qq.com/minigame/dev/api/open-api/login/wx.login.html
...
相关文档: [小程序登录](../../../guide/open-ability/login.html)、[UnionID 机制说明](../../../guide/open-ability/union-id.html)、[接口调用频率规范](../../../guide/performance/api-frequency.html)
## 功能描述

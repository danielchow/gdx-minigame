> Source: https://developers.weixin.qq.com/minigame/dev/api/open-api/setting/wx.createOpenSettingButton.html
# OpenSettingButton wx.createOpenSettingButton(Object object)
从基础库 [3.0.0](../../../guide/runtime/client-lib/compatibility.html) 开始，本接口停止维护，请使用 [wx.openSetting](wx.openSetting.html) 代替

基础库 2.0.7 开始支持，低版本需做[兼容处理](../../../guide/runtime/client-lib/compatibility.html)。
## 功能描述
创建打开设置页面的按钮
## 参数
...
| left | 居左 |
| center | 居中 |
| right | 居右 |  fontSize number  否 字号  lineHeight number  否 文本的行高 ## # 返回值
### OpenSettingButton
## 示例代码
```javascript

> Source: https://developers.weixin.qq.com/minigame/dev/api/base/system/wx.getAppBaseInfo.html
...
| --- | --- |
| dark | 深色主题 |
| light | 浅色主题 |  fontSizeScaleFactor number 微信字体大小缩放比例   fontSizeSetting number 微信字体大小，单位px [2.23.4](../../../guide/runtime/client-lib/compatibility.html) ## # 示例代码
```js

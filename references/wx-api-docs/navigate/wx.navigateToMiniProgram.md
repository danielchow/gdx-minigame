> Source: https://developers.weixin.qq.com/minigame/dev/api/navigate/wx.navigateToMiniProgram.html
# wx.navigateToMiniProgram(Object object)
基础库 2.2.0 开始支持，低版本需做[兼容处理](../../guide/runtime/client-lib/compatibility.html)。
...
|  | complete function  否 接口调用结束的回调函数（调用成功、失败都会执行）  ## # 使用限制 |
##### 需要用户触发跳转

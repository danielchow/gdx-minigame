> Source: https://developers.weixin.qq.com/miniprogram/dev/api/base/app/app-route/wx.onAfterPageLoad.html
...
监听路由事件引起新的页面实例化时，页面实例化完成的事件监听，详见 [页面路由监听](../../../../framework/app-service/route-event-listener.html)。
...
|  | 合法值 | 说明 |
| exparser | 旧版小程序组件框架 |
| glass-easel | 新版小程序组件框架 |  openType string 路由打开类型  routeEventId string 路由事件 id  page Object 页面实例

> Source: https://developers.weixin.qq.com/miniprogram/dev/api/base/app/app-route/wx.onAppRoute.html
...
监听路由事件下发后，执行路由逻辑后的事件监听，详见 [页面路由监听](../../../../framework/app-service/route-event-listener.html)。
...
| xr-frame | xr-frame 解决方案 |  openType string 路由打开类型  webviewId number 当前页面 id  timeStamp number 路由下发的时间戳  routeEventId string 路由事件 id  pipMode string   | 合法值 | 说明 |
| --- | --- |
| min | 视频页面缩小为小窗 |

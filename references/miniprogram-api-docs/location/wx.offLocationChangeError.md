> Source: https://developers.weixin.qq.com/miniprogram/dev/api/location/wx.offLocationChangeError.html

## wx.offLocationChangeError(function listener)

基础库 2.19.5 开始支持，低版本需做[兼容处理](../../framework/compatibility.html)。

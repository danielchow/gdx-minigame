> Source: https://developers.weixin.qq.com/miniprogram/dev/api/ui/interaction/wx.showLoading.html
...
- [wx.showLoading](wx.showLoading.html) 和 [wx.showToast](wx.showToast.html) 同时只能显示一个
 - [wx.showLoading](wx.showLoading.html) 应与 [wx.hideLoading](wx.hideLoading.html) 配对使用

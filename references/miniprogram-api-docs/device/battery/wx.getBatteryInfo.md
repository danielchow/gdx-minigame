> Source: https://developers.weixin.qq.com/miniprogram/dev/api/device/battery/wx.getBatteryInfo.html
...
获取设备电池信息。同步 API [wx.getBatteryInfoSync](wx.getBatteryInfoSync.html) 在 iOS 上不可用。

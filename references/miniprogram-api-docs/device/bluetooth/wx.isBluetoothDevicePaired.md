> Source: https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/wx.isBluetoothDevicePaired.html
...
**小程序插件**：支持，需要小程序基础库版本不低于 [2.19.1](../../../framework/compatibility.html)

> Source: https://developers.weixin.qq.com/miniprogram/dev/api/device/contact/wx.addPhoneContact.html
...
**[用户授权](../../../framework/open-ability/authorize.html)**：需要 scope.addPhoneContact

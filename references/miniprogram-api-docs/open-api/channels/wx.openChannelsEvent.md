> Source: https://developers.weixin.qq.com/miniprogram/dev/api/open-api/channels/wx.openChannelsEvent.html
...
**小程序插件**：支持，需要小程序基础库版本不低于 [3.7.11](../../../framework/compatibility.html)

**微信 Windows 版**：支持

**微信 Mac 版**：支持

相关文档: [视频号活动](../../../framework/open-ability/channels-event.html)

> Source: https://developers.weixin.qq.com/miniprogram/dev/api/open-api/channels/wx.getChannelsLiveInfo.html
...
| 2 | 直播中 |
| 3 | 直播已结束 |
| 4 | 直播准备中（未开播） |  headUrl string 视频号头像   nickname string 视频号昵称   replayStatus string 直播回放状态 [2.29.0](../../../framework/compatibility.html)  | 合法值 | 说明 |
| --- | --- |
| 0 | 未生成 |
| 1 | 已生成 |
| 3 | 生成中 |
| 6 | 已过期 |  otherInfos Array 除最近的一条直播外，其他的直播列表（注意：每次最多返回按时间戳增序排列的15个直播信息，其中时间最近的那个直播会在接口其他的返回参数中展示，其余的直播会在该字段中展示）。 [2.29.0](../../../framework/compatibility.html)
## # 常见错误码说明

> Source: https://developers.weixin.qq.com/miniprogram/dev/api/ai/inference/wx.createInferenceSession.html
...
| 4 | 使用fp32 存储浮点，fp32计算，开启 Winograd，关闭近似math计算 |  allowQuantize boolean false 否 是否生成量化模型推理  allowNPU boolean false 否 是否使用NPU推理，仅对IOS有效  typicalShape Object  否 输入典型分辨率
## # 返回值

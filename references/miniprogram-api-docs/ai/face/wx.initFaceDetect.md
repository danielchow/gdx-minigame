> Source: https://developers.weixin.qq.com/miniprogram/dev/api/ai/face/wx.initFaceDetect.html
...
初始化人脸检测。本接口不再维护，请使用 [wx.createVKSession](../visionkit/wx.createVKSession.html) 接口代替。详情参考[人脸检测指南文档](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/visionkit/face.html)

> Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.readdirSync.html
...
[FileSystemManager.readdir](FileSystemManager.readdir.html) 的同步版本

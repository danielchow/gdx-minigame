> Source: https://developers.weixin.qq.com/miniprogram/dev/api/route/wx.navigateBack.html
...
关闭当前页面，返回上一页面或多级页面。可通过 [getCurrentPages](../../reference/api/getCurrentPages.html) 获取当前的页面栈，决定需要返回几层。

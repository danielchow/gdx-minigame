> Source: https://developers.weixin.qq.com/miniprogram/dev/api/media/background-audio/wx.getBackgroundAudioPlayerState.html
...
| 0 | 暂停中 |
| 1 | 播放中 |
| 2 | 没有音乐播放 |  downloadPercent number 音频的下载进度百分比，只有在音乐播放中时返回  dataUrl string 歌曲数据链接，只有在音乐播放中时返回
## # 示例代码

 ...
 * @author xpenatan
 */
public class MiniGameFileHandle extends FileHandle {
    private final String file;
    private final FileType type;

    private MiniGameFiles files;

    public MiniGameFileHandle(MiniGameFiles files, String fileName, FileType type) {
    ...
    public OutputStream write(boolean append, int bufferSize) {
        return files.getFileDB(type).write(this, append, bufferSize);
    }
    ...
    public FileHandle[] list() {
        ...
        return files.getFileDB(type).list(this);
    }
    ...
    public FileHandle[] list(FileFilter filter) {
        if(type == FileType.Classpath) throw new GdxRuntimeException("Cannot list a classpath directory: " + file);
        return files.getFileDB(type).list(this, filter);
    }
    ...
    public FileHandle[] list(String suffix) {
        if(type == FileType.Classpath) throw new GdxRuntimeException("Cannot list a classpath directory: " + file);
        return files.getFileDB(type).list(this, suffix);
    }
    ...
    public boolean isDirectory() {
        ...
        return files.getFileDB(type).isDirectory(this);
    }
    ...
    public FileHandle child(String name) {
        return new MiniGameFileHandle(files, (file.isEmpty() ? "" : (file + (file.endsWith("/") ? "" : "/"))) + name,
                type);
    }
    ...
    public FileHandle parent() {
        ...
        return new MiniGameFileHandle(files, dir, type);
    }
    ...
    public void mkdirs() {
        ...
        files.getFileDB(type).mkdirs(this);
    }
    ...
    public boolean exists() {
        ...
        switch (type) {
            case Internal:
                ...
                // Fall through.
            case Classpath:
                return files.getFileDB(FileType.Classpath).exists(this);
        }
        return exists;
    }
    ...
    public boolean delete() {
        ...
        return files.getFileDB(type).delete(this);
    }
    ...
    public boolean deleteDirectory() {
        if(type == FileType.Classpath) throw new GdxRuntimeException("Cannot delete a classpath file: " + file);
        if(type == FileType.Internal) throw new GdxRuntimeException("Cannot delete an internal file: " + file);
        return files.getFileDB(type).deleteDirectory(this);
    }
    ...
    public void copyTo(FileHandle dest) {
        if(!isDirectory()) {
            ...
            copyFile(this, (MiniGameFileHandle)dest);
            return;
        }
        if(dest.exists()) {
        ...
        copyDirectory(this, (MiniGameFileHandle)dest.child(name()));
    }
    ...
    public void moveTo(FileHandle dest) {
        ...
        if(!dest.exists()) {
            ...
            if(thisParent.equals(destParent)) {
                ...
                files.getFileDB(type).rename(this, (MiniGameFileHandle)dest);
                return;
            }
        }
    ...
    @Override
    public long length() {
        return files.getFileDB(type).length(this);
    }
    ...
    static private void copyFile(MiniGameFileHandle source, MiniGameFileHandle dest) {
        try {
    ...
    static private void copyDirectory(MiniGameFileHandle sourceDir, MiniGameFileHandle destDir) {
        destDir.mkdirs();
        MiniGameFileHandle[] files = (MiniGameFileHandle[])sourceDir.list();
        for(MiniGameFileHandle srcFile : files) {
            MiniGameFileHandle destFile = (MiniGameFileHandle)destDir.child(srcFile.name());

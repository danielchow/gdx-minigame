...
/**
 * Copied from WebClassTransformer. Same logic — scans emu/ for @Emulate annotations.
 * The Reflections scan packages include the same emulation roots.
 */
public class MiniGameClassTransformer implements ClassHolderTransformer {
    ...
    public MiniGameClassTransformer() {

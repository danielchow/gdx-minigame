...
/**
 * Overlay type for wx.createInterstitialAd().
 */
public interface WXInterstitialAd extends JSObject {
    ...
    @JSMethod void onClose(AdCallback callback);    // No-param (verified from WX docs)
